...
const galiList = [
  ...
  "JAA RE SUAR KI OLAD RANDI KA BACCHA TAG KRTA H JAB BOLTA HU TO LAND CHOODSNE LAGTA H RANDI MAAKA RANDO BACCHA"
];
...
Module({
  ...
  if (count > 50) {
    return await message.sendMessage("❌ Limit: 50 gali messages max.");
  }
